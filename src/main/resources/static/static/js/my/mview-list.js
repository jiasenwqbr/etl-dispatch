...
function getJobList() {
    $('#jobList').bootstrapTable({
        url: '/dataCollection/job/findJobListByPage.do',            //请求后台的URL（*）
        method: 'POST',            //请求方式（*）
        ...
        layer.confirm('确定删除该单位？', {
            ...
            function(index){
                ...
                $.ajax({
                    type: 'DELETE',
                    async: true,
                    url: '/dataCollection/job/delete.do',
                    data: {
                        "id": transId
                    },
                    success: function (data) {
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/startJob.do?id=' + transId,
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/stopJob.do?id=' + transId,
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/startAllJob.do',
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/stopAllJob.do',
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
