$(document).ready(function () {
    $("#id").val(getQueryVariable("categoryId"));
    // 提交按钮监听
    submitListener();
    // 初始化数据
    initData();
...
function initData(){
    ...
    if (categoryId && categoryId !== "") {
        $.ajax({
            type: 'GET',
            async: false,
            url: '/dataCollection/category/getCategoryDetail?id=' + categoryId,
            data: {},
    ...
    $("#CategoryForm").validate({
        rules: {
            categoryName: {
                ...
                remote:{
                    type: 'POST',
                    cache: false,
                    url: '/dataCollection/category/categoryExist',
                    data: {
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                type: 'PUT',
                async: false,
                url: '/dataCollection/category/update',
