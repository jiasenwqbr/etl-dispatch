...
function getJobList() {
    $('#jobList').bootstrapTable({
        url: '/dataCollection/job/findJobListByPage',            //请求后台的URL（*）
        method: 'POST',            //请求方式（*）
...
function bindButton() {
    ...
    $('#jobList').delegate('#edit','click',function(e) {
        ...
        location.href = "./edit.html?jobId=" + jobId;
    });
        ...
        layer.confirm('确定删除该作业？', {
            ...
            function(index){
                ...
                $.ajax({
                    type: 'DELETE',
                    async: true,
                    url: '/dataCollection/job/delete?id='+transId,
                    success: function (data) {
                        if (data.success) {
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/startJob?id=' + transId,
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/stopJob?id=' + transId,
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/startAllJob',
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
        ...
        layer.confirm(
            ...
            function (index) {
                ...
                $.ajax({
                    type: 'GET',
                    async: true,
                    url: '/dataCollection/job/stopAllJob',
                    data: {},
                    success: function (data) {
                        if (data.success) {
                            location.replace(location.href);
